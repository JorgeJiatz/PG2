...
from .views import ClienteView, ClienteEdit, ClienteNew, clienteInactivar, \
    FacturaView, facturas, ProductView, del_detalle_factura,facturar , info_cliente,ver_factura,anularFactura
...
urlpatterns = [
    ...
    path('facturas/anularFactura',anularFactura, name="anularFactura"),
]