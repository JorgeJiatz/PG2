...
class FacturaDet(ClaseModelo2):
    ...
    def save(self):
        resultado_sub_total = float(float(self.cantidad) * float(self.precio))
        self.sub_total = round(resultado_sub_total,2)
        self.total = round((self.sub_total - float(self.descuento)),2)
